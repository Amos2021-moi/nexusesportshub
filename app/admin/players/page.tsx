...
const DecorBackground = memo(() => {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-gradient-to-br from-gray-900 via-gray-900 to-indigo-950">
      ...
      <div className="absolute right-0 top-1/3 h-96 w-96 rounded-full bg-green-500/10 blur-3xl" />
      <div className="absolute bottom-0 left-1/3 h-96 w-96 rounded-full bg-indigo-600/15 blur-3xl" />
      <div
...
const StatCard = memo(({ stat }: { stat: any }) => {
  ...
  return (
    <div className={`group relative h-full overflow-hidden rounded-2xl border bg-white/5 p-4 shadow-xl backdrop-blur-xl transition-colors duration-150 hover:border-emerald-500/40 ${stat.ring}`}>
...
const SeasonCard = memo(({ season, onEdit, onDelete, onStatusUpdate }: {
  ...
  const handleStatusUpdate = useCallback((status: string) => onStatusUpdate(season.id, status), [onStatusUpdate, season.id]);
          ...
          <div className="mt-4 flex flex-wrap gap-1.5">
            {statusOptions.map((opt) => (
              <button
                ...
                className={`min-h-[32px] rounded-lg px-2.5 py-1 text-xs font-medium transition-colors duration-150 ${
...
export default function AdminSeasonsPage() {
  ...
  const totalFixtures = useMemo(() => 
    seasons.reduce((sum, s) => sum + (s._count?.fixtures || 0), 0),
    [seasons]
  );
  
  const totalPlayers = useMemo(() => 
    seasons.reduce((sum, s) => sum + (s._count?.leagueEntries || 0), 0),
    [seasons]
  );
  ...
  return (
    <>
      ...
      <div className="space-y-4 px-3 pb-20 sm:space-y-6 sm:px-4 lg:px-6">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-r from-emerald-600/20 via-green-600/20 to-indigo-600/20 p-4 shadow-2xl backdrop-blur-xl sm:p-6">
          ...
          <div className="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 truncate text-xs text-gray-300 sm:text-sm">Create and manage league seasons with lifecycle tracking</p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="min-h-[44px] w-full rounded-xl border border-white/10 bg-gray-900/50 py-2 pl-10 pr-4 text-white placeholder-gray-500 transition-colors duration-150 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
              />
            </div>
            <div className="relative sm:w-64">
              ...
              <select
                ...
                className="min-h-[44px] w-full appearance-none rounded-xl border border-white/10 bg-gray-900/50 py-2 pl-10 pr-8 text-white transition-colors duration-150 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
              >
        ...
        {/* Create/Edit Modal - NO animations */}
        {showForm && (
          <div
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="min-h-[44px] w-full rounded-xl border border-white/10 bg-gray-900/60 p-3 text-white placeholder-gray-500 transition-colors duration-150 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="min-h-[44px] w-full rounded-xl border border-white/10 bg-gray-900/60 p-3 text-white transition-colors duration-150 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
                    />
                  </div>
                  <div>
                ...
                <label className="flex min-h-[44px] cursor-pointer items-center gap-3 rounded-xl border border-white/10 bg-gray-900/40 p-3 text-sm text-gray-300 transition-colors duration-150 hover:bg-gray-900/60">
                  <input
                    type="checkbox"
                    id="isActive"
                ...
                <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex min-h-[44px] flex-1 items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-green-600 py-2 font-semibold text-white shadow-lg shadow-emerald-900/30 transition-all duration-150 hover:from-emerald-700 hover:to-green-700 disabled:opacity-50"
                  >
                    {submitting ? (
                      <>
