  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-amber-600 via-yellow-600 to-orange-600 p-6 shadow-2xl shadow-amber-500/20 md:p-8"
      >
        ...
        />
        <motion.div
          className="absolute -bottom-16 left-10 h-56 w-56 rounded-full bg-orange-400/20 blur-3xl"
        ...
        <div className="relative z-10">
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="flex gap-2">
              <Link
                href={`/admin/tournaments/${id}/manage`}
              ...
              <Link
                href={`/admin/tournaments/${id}/stats`}
                className="inline-flex min-h-[44px] items-center gap-2 rounded-xl bg-white/10 px-4 py-2 text-sm text-white ring-1 ring-white/20 backdrop-blur-sm transition-all hover:bg-white/20"
              >
                <BarChart3 size={16} />
                Stats
