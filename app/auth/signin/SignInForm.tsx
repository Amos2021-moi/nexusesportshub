...
const FacebookIcon = memo(function FacebookIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#1877F2"
        ...
        >
          ...
          >
            <div className="mb-4 sm:mb-6">
              <h2 className="text-lg font-semibold text-white sm:text-xl">Sign in</h2>
              <p className="mt-0.5 text-xs text-gray-400 sm:text-sm">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              ...
              >
                ...
                <span className="inline xs:hidden">G</span>
              </button>
            ...
            <form onSubmit={handleCredentialsSignIn} noValidate className="space-y-3 sm:space-y-4">
              ...
              <div>
                <div className="mb-1 flex items-center justify-between sm:mb-1.5">
                  <label
                    htmlFor="password"
                    className="block text-xs font-medium text-gray-300 sm:text-sm"
                  >
                    Password
                  </label>
                  <Link
              ...
              <div className="flex items-center">
                <label
                  htmlFor="rememberMe"
                  className="flex cursor-pointer select-none items-center gap-2 text-xs text-gray-300 sm:text-sm"
                >
                  <input
                    id="rememberMe"
                    name="rememberMe"
                    ...
                    onChange={handleChange}
                    disabled={busy}
                    className="h-3.5 w-3.5 rounded border-white/20 bg-gray-900/60 text-indigo-600 accent-indigo-600 focus:ring-2 focus:ring-indigo-500/50 focus:ring-offset-0 sm:h-4 sm:w-4"
                  />
                  Remember me
                </label>
              </div>
