...
const SettingCard = memo(({
  ...
  const isMobile = useIsMobile();
  const hoverClass = isMobile ? "" : "hover:border-indigo-500/30 hover:shadow-indigo-500/10";

  return (
    <div className={`rounded-2xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-xl transition-all duration-150 ${hoverClass} ${className}`}>
      {children}
    </div>
  );
});
...
const ToggleSwitch = memo(({
  ...
  <div className="flex items-center justify-between rounded-xl border border-white/10 bg-gray-900/40 p-4">
    ...
    <label className={`relative inline-flex cursor-pointer items-center ${disabled ? "opacity-50 cursor-not-allowed" : ""}`}>
      ...
      />
      <div className={`h-6 w-11 rounded-full bg-gray-600 transition-colors duration-200 peer-checked:bg-indigo-600`}>
        <div className={`m-1 h-4 w-4 rounded-full bg-white transition-transform duration-200 ${checked ? "translate-x-5" : ""}`} />
      </div>
    </label>
  </div>
));
    ...
    <div className="mx-auto flex max-w-3xl items-center justify-between gap-4 px-4 py-3">
      ...
      <div className="flex w-full gap-3 sm:w-auto">
        <button
          type="button"
          onClick={onCancel}
          className="min-h-[44px] flex-1 rounded-xl border border-white/10 bg-gray-800/50 px-6 py-2.5 text-gray-400 transition-colors duration-150 hover:bg-gray-700/50 hover:text-white sm:flex-none"
        >
          Cancel
        </button>
        <button
          ...
          onClick={onSubmit}
          disabled={saving}
          className={`flex min-h-[44px] flex-1 items-center justify-center gap-2 rounded-xl px-6 py-2.5 font-semibold text-white shadow-lg transition-colors duration-150 disabled:opacity-50 sm:flex-none ${
            saveSuccess
    ...
    <>
      ...
      <div className="relative min-h-screen pb-28 px-3 sm:px-4 lg:px-6">
        <div className="max-w-3xl mx-auto space-y-5 sm:space-y-6">
          ...
          {/* Account Summary Card - NO animations */}
              ...
              <div className="flex items-end gap-4">
                <div className="relative h-20 w-20 flex-shrink-0">
                  <div className="h-20 w-20 overflow-hidden rounded-2xl border-4 border-gray-900 bg-gradient-to-br from-indigo-500 to-purple-600 shadow-xl">
                    {profilePicture ? (
                      <img src={profilePicture} alt="Profile" className="h-full w-full object-cover" loading="lazy" />
                    ) : (
          ...
          <form className="space-y-5">
            ...
            {/* Personal Information - NO animations */}
            <SettingCard>
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="min-h-[44px] w-full rounded-xl border border-white/10 bg-gray-900/60 px-4 py-2.5 pl-10 text-white transition-colors duration-150 focus:border-indigo-500/60 focus:outline-none focus:ring-2 focus:ring-indigo-500/40"
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full resize-none rounded-xl border border-white/10 bg-gray-900/60 px-4 py-2.5 text-white transition-colors duration-150 focus:border-indigo-500/60 focus:outline-none focus:ring-2 focus:ring-indigo-500/40"
            ...
            {/* Gaming Preferences - NO animations */}
            <SettingCard>
            ...
            {/* Match Communication - NO animations */}
            <SettingCard>
              ...
              <label htmlFor="whatsappVisible" className="mt-4 flex min-h-[44px] cursor-pointer items-center justify-between gap-3 rounded-xl border border-white/10 bg-gray-900/40 p-3 transition-colors duration-150 hover:bg-gray-900/60">
                ...
                <div className="relative inline-flex flex-shrink-0 items-center">
                  ...
                  />
                  <div className="h-6 w-11 rounded-full bg-gray-600 transition-colors duration-200 peer-checked:bg-indigo-600">
                    <div className={`m-1 h-4 w-4 rounded-full bg-white transition-transform duration-200 ${formData.whatsappVisible ? "translate-x-5" : ""}`} />
                  </div>
                </div>
              </label>
            </SettingCard>

            {/* Email Settings - NO animations */}
            <SettingCard>
                  ...
                  {!emailStatus.verified && (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex min-h-[44px] items-center gap-2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-2 text-sm text-white shadow-lg shadow-indigo-500/30 transition-colors duration-150 hover:shadow-indigo-500/50 disabled:opacity-50"
                      >
                      ...
                      <button
                        ...
                        className="flex min-h-[44px] items-center gap-2 rounded-lg border border-white/10 bg-gray-700/40 px-4 py-2 text-sm text-white transition-colors duration-150 hover:bg-gray-600/40 disabled:opacity-50"
                      >
            ...
            {/* Security Tip - NO animations */}
            <div className="relative overflow-hidden rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-indigo-500/5 p-5 backdrop-blur-xl">
